...
const ContactPage = (props) => {
    ...
    return (
        <div>
            ...
            <Title darkMode={props.darkMode}  title='1.About Sphinx' description='Sphinx.com is a global travel service provider offering a seamless experience for booking hotels, flights, and more.
         Available in 24 languages and covering 39 countries, we aim to make travel easy for millions worldwide.'/>
            <Title darkMode={props.darkMode} title='2. Our Network' description='With over 1.1 million hotels and partnerships with 510+ airlines, 
       Sphinx.com provides a comprehensive travel network that covers more than 3,400 airports in 220 countries and regions globally.'/>
            ...
            <Title darkMode={props.darkMode} title='3. 24/7 Customer Support' description='Our customer support team is available 24/7 in multiple languages, ensuring that you receive assistance whenever you need it,
       with additional centers in Cairo, Dubai, and Riyadh for personalized help.'/>
            ...
            <Title darkMode={props.darkMode} title='4. Booking Your Trip' description='Booking your trip is easy with Sphinx.com. Whether you’re looking for flights, hotels, 
      or car rentals, our platform offers a fast and user-friendly experience to help you plan the perfect journey.'/>
            <Title darkMode={props.darkMode} title='5. Global Reach' description='Sphinx.com operates in 220 countries and regions, 
